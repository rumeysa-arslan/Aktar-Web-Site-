...
// 2. Veritabanından "Öne Çıkan" ürünleri çek (Rastgele 4 ürün)
try {
    // SQL_CALC_FOUND_ROWS vb. yerine basit bir LIMIT kullanalım
    ...
    $one_cikan_urunler = []; // Hata olursa boş dizi
}
?>
...
<header>
    <nav class="main-nav">
        ...
        <ul>
            ...
            <?php 
            // Sepetteki toplam ürün sayısını (adet değil, çeşit) hesapla
...
<main>
    <div class="container">
        ...
        <div class="urun-grid">
            <?php 
            // Veritabanından gelen ürünleri döngüye al
